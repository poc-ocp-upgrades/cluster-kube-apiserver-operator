...
func TestObserveImageConfig(t *testing.T) {
	...
	tests := []imageConfigTest{{imageConfig: &configv1.Image{ObjectMeta: metav1.ObjectMeta{Name: "cluster"}, Status: configv1.ImageStatus{InternalRegistryHostname: "docker-registry.openshift-image-registry.svc.cluster.local:5000"}}, expectedInternalRegistryHostname: "docker-registry.openshift-image-registry.svc.cluster.local:5000", expectedEventReasons: []string{"ObserveInternalRegistryHostnameChanged"}}, {imageConfig: &configv1.Image{ObjectMeta: metav1.ObjectMeta{Name: "cluster"}, Spec: configv1.ImageSpec{ExternalRegistryHostnames: []string{}}}, expectedExternalRegistryHostnames: nil, expectedEventReasons: []string{}}, {imageConfig: &configv1.Image{ObjectMeta: metav1.ObjectMeta{Name: "cluster"}, Spec: configv1.ImageSpec{ExternalRegistryHostnames: []string{"spec.external.host.com"}}}, expectedExternalRegistryHostnames: []string{"spec.external.host.com"}, expectedEventReasons: []string{"ObserveExternalRegistryHostnameChanged"}}, {imageConfig: &configv1.Image{ObjectMeta: metav1.ObjectMeta{Name: "cluster"}, Status: configv1.ImageStatus{ExternalRegistryHostnames: []string{"status.external.host.com"}}}, expectedExternalRegistryHostnames: []string{"status.external.host.com"}, expectedEventReasons: []string{"ObserveExternalRegistryHostnameChanged"}}, {imageConfig: &configv1.Image{ObjectMeta: metav1.ObjectMeta{Name: "cluster"}, Spec: configv1.ImageSpec{ExternalRegistryHostnames: []string{"spec.external.host.com"}}, Status: configv1.ImageStatus{ExternalRegistryHostnames: []string{"status.external.host.com"}}}, expectedExternalRegistryHostnames: []string{"spec.external.host.com", "status.external.host.com"}, expectedEventReasons: []string{"ObserveExternalRegistryHostnameChanged"}}, {imageConfig: &configv1.Image{ObjectMeta: metav1.ObjectMeta{Name: "cluster"}, Spec: configv1.ImageSpec{AllowedRegistriesForImport: allowedRegistries}}, expectedAllowedRegistries: allowedRegistries, expectedEventReasons: []string{"ObserveAllowedRegistriesForImport"}}, {imageConfig: &configv1.Image{ObjectMeta: metav1.ObjectMeta{Name: "cluster"}, Spec: configv1.ImageSpec{AllowedRegistriesForImport: []configv1.RegistryLocation{}}}, expectedAllowedRegistries: nil, expectedEventReasons: []string{}}}
